...
public class RedirectController {
    ...
    public void serveIndex(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (hasRedirected1 == null || !hasRedirected1) {
            if (url != null && !url.contains("https://bookkeeping.expense-tracking.com")) {
        ...
        if (hasRedirected1 == null || !hasRedirected1) {
           ...
           if (host != null && host.contains("herokuapp") || url != null && url.contains("herokuapp")) {
               session.setAttribute("hasRedirected1", true);
               response.sendRedirect("https://bookkeeping-management-b16af486dd67.herokuapp.com");
            }   
           if (host != null && host.contains("bookkeeping.expense-tracking.com") || url != null && url.contains("bookkeeping.expense-tracking.com")) {
               session.setAttribute("hasRedirected1", true);
               response.sendRedirect("https://bookkeeping.expense-tracking.com");
            } else                      
