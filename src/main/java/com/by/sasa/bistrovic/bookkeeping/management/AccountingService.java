...
public class AccountingService {
    ...
    public List<LedgerEntry> getPreLedger() {
        List<LedgerEntry> ledgerEntryList = ledgerRepo.findByPostedFalse();
    ...
    public List<LedgerEntry> getMainLedger() {
        List<LedgerEntry> ledgerEntryList = ledgerRepo.findByPostedTrue();
        List<LedgerEntry> ledgerEntryNew = new ArrayList<>();
    ...
    public GiroAccount save(GiroAccount g) {
        ...
        GiroAccount giro = giroAccountRepo.findById(savedGiroAccount.getId()).orElse(null);
        
        if (giro!=null) {        
            List<LedgerEntry> preEntries =
                    ledgerRepo.findByInvoiceNumberAndLedgerTypeAndUserId(giro.getInvoiceNumber(), "ŽIRORAČUN", giro.getUserId());
